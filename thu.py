...
def train_model():
    ...
    # test
    print("Bắt đầu test!")
    pickle.dump(classifier, open("handwrite_model_khongchia", 'wb'))
...
def test_model():
    classifier = pickle.load(open("handwrite_model_khongchia", 'rb'))
    training_data, test_data = loadMnistData()
...
predict_image(test_data[0][1])

# predict_image("/home/teo/STUDY/images/image_1.jpg")

# show_image("/home/teo/STUDY/images/image_1.jpg")
